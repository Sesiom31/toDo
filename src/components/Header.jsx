...
function Header() {
  return (
    ...
    k text-gray-100 px-2 sm:px-4 md:px-7 lg:px-8 pr-4">
      <section className="flex gap-3 items-center justify-center h-8 w-auto sm:gap-16 md:gap-20 lg:gap-40 ">
        ...
        <label
          htmlFor="search"
          className="w-40 h-8 rounded-md bg-gray-200 text-orange-600 flex items-center overflow-hidden sm:w-72 md:w-96 
          lg:w-[500px] "
        >
